...
1. Clawdbot actually **drove Claude usage** — many users specifically configured Clawdbot to use Claude as its underlying model
2. This was a **rapidly rising project** bringing Anthropic free marketing and API revenue
3. The renaming chaos caused **actual security disasters and financial losses**
4. The similarity between "Clawd" and "Claude" was obviously **playful**, not malicious infringement
